...
const FURNITURE_MODELS = {
  'src/panel/models/bed.glb': { name: 'Bed' },
  'src/panel/models/chair.glb': { name: 'Chair' },
  'src/panel/models/sofa.glb': { name: 'Sofa' },
  'src/panel/models/ikea_idanas_single_bed.glb': { name: 'IKEA Bed' }
};
