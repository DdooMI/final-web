          ...
          <div className="hidden xl:flex items-center gap-x-4">
            ...
            {user && (
              <div className="flex items-center gap-x-4">
                ...
                <NavLink to="/profile" className="flex items-center space-x-2 rounded-full border border-[#C19A6B]/20 hover:border-[#C19A6B] transition-all duration-300 shadow-sm">
